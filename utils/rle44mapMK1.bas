...
Sub usage
	Print "Usage:"
	Print 
	Print "$ rle44mapMK1.exe in.map out.h w h tlock prefix [offset] [scrsizes] [nodecos] [bin]"
End Sub
...
Print #f, "// rle44mapMK1(TM) map " & Command (2)
Print #f, "// Generated by rle44mapMK1.exe"
