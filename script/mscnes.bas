...
print #f, "// Copyleft 2013/2014 The Mojon Twins"
print #f, " "
print #f, "void __fastcall__ msc_init_all (void) {"
print #f, "    for (gpit = 0; gpit < MAX_FLAGS; gpit ++)"
print #f, "        flags [gpit] = 0;"
print #f, "}"
print #f, " "
print #f, "unsigned char __fastcall__ read_byte (void) {"
print #f, "    return *script++;"
print #f, "}"
print #f, " "
print #f, "unsigned char __fastcall__ read_vbyte (void) {"
...
print #f, "void __fastcall__ run_script (void) {"
...
if actionsUsed (&HE3) Then
	...
	print #f, "                           update_list [update_index++] = n;"
	print #f, "                           x ++;"
	print #f, "                        }"                
	print #f, "                        ppu_waitnmi ();"
	print #f, "                        clear_update_list ();"
